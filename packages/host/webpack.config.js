...
const config = {
  ...
  plugins: [
    ...
    new webpack.DefinePlugin({
      ...
      'process.env.ZE_PUBLIC_REMOTE_METRICS_URL': JSON.stringify(process.env.ZE_PUBLIC_REMOTE_METRICS_URL || 'http://localhost:3002/remoteEntry.js'),
      ...
      'process': JSON.stringify({
        env: {
          ...
          ZE_PUBLIC_REMOTE_METRICS_URL: process.env.ZE_PUBLIC_REMOTE_METRICS_URL || 'http://localhost:3002/remoteEntry.js',
        },
      }),
    }),
  ],
